...
type FlowState = 'idle' | 'device_connected' | 'service_selected' | 'waiting_for_mode' | 'unlocking' | 'success' | 'error';
        ...
        <GlassCard className="flex flex-col gap-8 liquid-glass relative overflow-hidden">
          ...
          <div className="flex items-center justify-between z-10">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-white">Android Auto-Unlock</h3>
